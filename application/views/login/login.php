        ...
        <div class="container content-wrapper">
           <div class="row">
              <div class="col-md-12" style="margin-top: -30px;margin-bottom: -20px;">
                  <h4 class="page-head-line">SELAMAT DATANG DI SIAKAD STIKES KELUARGA BUNDA JAMBI</h4>
              </div>
            </div>
            <div class="row">
                 <div class="col-md-4">
                      ...
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="item active">
                            <img src="images/slide/2.jpg" alt="Los Angeles" style="width:100%; height: 400px;">
                          </div>
                    
                          <div class="item">
                            <img src="images/slide/1.jpg" alt="Chicago" style="width:100%; height: 400px;">
                          </div>
                        
                          <div class="item">
                            <img src="images/slide/3.jpg" alt="New york" style="width:100%; height: 400px;">
                          </div>
                        </div>
