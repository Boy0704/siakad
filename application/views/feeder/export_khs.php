...
if ($_GET) {
	...
	header("Content-Disposition: attachment; filename=Export_nilai_Feeder.xls");
 ?>
...
<table border="1">
	<tr>
		...
		<td style="background-color: red">NILAI HURUF</td>
		<td style="background-color: red">NILAI INDEKS</td>
		<td style="background-color: red">NILAI ANGKA</td>
