...
//                 $login=  $this->db->get_where('app_users',array('username'=>$username, 'password'=>hash_verify($password)));
//                 if($login->num_rows()>0 )//and $this->session->userdata('mycaptcha')==$capth
//                 {
//                     $r=  $login->row();
//                     // $verifikasi = hash_verify($password, $r->password);
//                     // if (!$verifikasi)
//                     // {
//                     //     $this->session->set_flashdata('login_response', 'Username and Pasword tidak valid!! ');
//                     //     redirect('login');
//                     // }
//                     // else
//                     // {
...
//     //     $this->session->sess_destroy();
//     //     // $this->session->unset_userdata(array('level', 'username', 'sess_login_absen', 'keterangan', 'konsentrasi_id'));
//     //     // redirect(base_url());
//     //     redirect('login');
//     // }
